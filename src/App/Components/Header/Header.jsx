      ...
      <div className="navbar bg-[#000] py-4">
        <div className="max-w-[1144px] w-[83%] mx-auto flex justify-between items-center relative ">
          <div className="navbar-start">
            <a className="font-pops font-bold max-[375px]:text-[1.5rem] sm:text-[1.5rem] lg:text-3xl blend cursor-pointer">
              Russell K.
            </a>
          </div>

          <div className="navbar-center max-[375px]:hidden lg:flex">
          ...
          <div className="navbar-end flex relative">
            ...
            <ul
              tabIndex="0"
              className={`max-[375px]:w-auto max-[375px]:right-[-33px] menu menu-sm dropdown-content absolute right-[-116px] mt-[49px] z-10 p-8 shadow bg-[#0d0d0dbd]  w-[20rem] h-[100vh] transition-transform duration-300 ${
