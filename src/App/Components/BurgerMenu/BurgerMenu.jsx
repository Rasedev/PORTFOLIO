...
//       <animated.div style={divOneStyles} className="absolute bg-white h-[0.15rem] w-full "></animated.div>
//       <animated.div style={divTwoStyles} className="absolute bg-white h-[0.15rem] w-full  top-[12px]"></animated.div>
//       <animated.div style={divThreeStyles} className="absolute bg-white h-[0.15rem] w-full "></animated.div>
//     </div>
//   );
// };
...
const BurgerMenu = ({ toggle, clicked, initialColor = 'white', toggledColor = '#28effa' }) => {
  const divOneStyles = useSpring({
    top: toggle ? '12px' : '2px',
    transform: toggle ? 'rotate(405deg)' : 'rotate(0deg)',
