...
const AboutPage = () => {
  ...
  return (
    <section id="about">
      <div className="flex flex-col items-center max-w-[1200px] w-[100%] pt-[60px] pb-[100px] ">
        <h1 className="max-[375px]:text-[1.5rem] text-[2rem] font-bold font-lato ">About Me<span className="color">.</span></h1>
        ...
        <div className="wrapper off">
          ...
          <div className="delay p-0 text-[1.4rem] font-normal capitalize">
            <h2 className="max-[375px]:text-center bg-darkgray p-4 mb-3 font-Josefin">My Craft</h2>
